        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[300px] md:auto-rows-[240px]">
          ...
          <div className="md:col-span-8 md:row-span-2 group relative overflow-hidden rounded-[30px] shadow-sm border border-white">
            ...
            <div className="absolute bottom-0 p-8">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-3">Verified Experience Creators</h3>
          ...
          {/* CARD 2: ESCROW TRUST (Dark High Contrast) */}
          <div className="md:col-span-4 md:row-span-2 bg-secondary rounded-[30px] p-8 flex flex-col justify-between relative overflow-hidden shadow-xl">
            ...
            <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Secured by Escrow</h3>
            ...
            <div className="pt-6 border-t border-white/10 relative z-10">
                <p className="pristina text-2xl text-cyan-400">Travel with Peace of Mind</p>
            </div>
          </div>

          {/* CARD 3: DISCOVERY (Tall Image) */}
          <div className="md:col-span-4 md:row-span-2 group relative overflow-hidden rounded-[30px] shadow-sm border border-white">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end">
               <h3 className="text-xl font-bold text-white mb-2">Curated Discoveries</h3>
               <p className="text-white/90 text-sm">Seamless execution from booking to the final destination.</p>
            </div>
          </div>

       {/* CARD 4: TRUST BACKGROUND HERO */}
